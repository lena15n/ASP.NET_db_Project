    ...
    <div class="all">
        ...
        <div class="whitecenter">
            ...
            <div class="enterpart" style="left: -20%; text-align: right">
                <form id="enterForm" class="form" method="post" runat="server" onsubmit="validateEnter(document.getElementById('enterForm'));"><!-- onsubmit="return validateEnter(document.getElementById('enterForm'));" -->
                    <p>&nbsp;</p>
